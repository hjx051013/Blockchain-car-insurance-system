...
const carOwner = require('../compiled/CarOwner.json');
const company = require('../compiled/Company.json');
const police = require('../compiled/Policer.json');

const Company = address => new web3.eth.Contract(JSON.parse(company.interface), address);
const CarOwner = address => new web3.eth.Contract(JSON.parse(carOwner.interface), address);
const Policer = address => new web3.eth.Contract(JSON.parse(police.interface), address);
